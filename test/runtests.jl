...
@testset "ET0 models" begin
  @test ET0_eq(200.0, 20.0, 2.0) == (2.456, 0.14474018811241365, 0.0013262323104019538, 6.971947723218883)
  @test ET0_Penman48(200.0, 20.0, 2.0, 2.0) ≈ 8.244854774487237
  @test ET0_FAO98(200.0, 20.0, 2.0, 2.0) ≈ 7.155857987319669
end
...
@testset "GOF" begin
  @test GOF(1:10, 2:11) ==
        (KGE=0.8181818181818181, NSE=0.8787878787878788, R2=1.0, R=1.0, RMSE=1.0, MAE=1.0, bias
    =1.0, bias_perc=18.181818181818183, n_valid=10)
end
